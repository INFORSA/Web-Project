...
function Event(){
    return(
        <div className="container min-h-sreen lg:h-72 w-auto grid gap-1 lg:grid-cols-3 md:grid-cols-2 my-3">
            <div className="rounded-lg w-72 bg-blue-950 text-white flex justify-center items-center mx-auto
            ...
            <div className="p-4 rounded-lg w-72 bg-blue-950 text-white flex flex-col justify-evenly items-start mx-auto
            transform transition-transform duration-300 ease-in-out hover:scale-110">
                <div>
            ...
            <div className="p-4 rounded-lg w-72 bg-blue-950 text-white flex flex-col justify-between items-start mx-auto
            transform transition-transform duration-300 ease-in-out hover:scale-110">
                <div>
