  ...
  return (
    <div className="text-white bg-kabinet">
      ...
      <div className="flex flex-col lg:flex-row md:flex-row justify-evenly">
        <motion.div variants={fadeIn("right", 0.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.7}} className="lg:w-1/2 text-left lg:h-60 mb-4">
        ...
        <motion.div variants={fadeIn("left", 0.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.7}} className="lg:w-1/2 text-right lg:h-60">
          <div className="text-sm lg:text-2xl font-semibold">
            Wakil Ketua Umum
          </div>
      ...
      <div className="flex flex-col lg:flex-row md:flex-row justify-between">
        <motion.div variants={fadeIn("right", 0.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.7}} className="lg:w-1/2 text-left mb-4 lg:h-60 lg:mb-0">
          <div className="text-sm lg:text-2xl font-semibold">
            Bendahara Umum
          </div>
        ...
        <motion.div variants={fadeIn("left", 0.2)} initial="hidden" whileInView={"show"} viewport={{once: false, amount: 0.7}} className="lg:w-1/2 lg:h-60 text-right">
          <div className="text-sm lg:text-2xl font-semibold">
            Sekretaris Umum
          </div>
